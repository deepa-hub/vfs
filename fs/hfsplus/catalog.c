		...
		struct qstr *str, struct inode *inode)
{
	...
	dir->i_mtime = dir->i_ctime = current_fs_time_sec(sb);
		       ...
		       struct inode *dst_dir, struct qstr *dst_name)
{
	...
	dst_dir->i_mtime = dst_dir->i_ctime = current_fs_time_sec(dst_dir->i_sb);
	...
	src_dir->i_mtime = src_dir->i_ctime = current_fs_time_sec(sb);
